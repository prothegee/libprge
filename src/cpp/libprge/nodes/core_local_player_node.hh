...
inline static const char *CORE_LOCAL_PLAYER_NODE_STATE_UNDEFINED_HINT = "Undefined"; // hint for CORE_LOCAL_PLAYER_NODE_STATE_UNDEFINED
inline static const char *CORE_LOCAL_PLAYER_NODE_STATE_LOADING_HINT = "Loading"; // hint for CORE_LOCAL_PLAYER_NODE_STATE_LOADING
inline static const char *CORE_LOCAL_PLAYER_NODE_STATE_IN_MENU_HINT = "In Menu"; // hint for CORE_LOCAL_PLAYER_NODE_STATE_IN_MENU
inline static const char *CORE_LOCAL_PLAYER_NODE_STATE_IN_GAMEPLAY_HINT = "In Gameplay"; // hint for CORE_LOCAL_PLAYER_NODE_STATE_IN_GAMEPLAY
inline static const char *CORE_LOCAL_PLAYER_NODE_STATE_IN_SOMEWHERE_SINCE_NOT_SURE_HINT = "In Somewhere, but not sure"; // hint for CORE_LOCAL_PLAYER_NODE_STATE_IN_SOMEWHERE_SINCE_NOT_SURE
